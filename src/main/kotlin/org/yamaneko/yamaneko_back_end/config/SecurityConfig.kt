...
class SecurityConfig(
  private val customUserDetailsService: CustomUserDetailsService, private val passwordSecurity: PasswordSecurity) {
  @Bean
  ...
  fun corsConfigurationSource(): CorsConfigurationSource {
    ...
    configuration.allowedHeaders = listOf(
      "Authorization", "Access-Control-Allow-Origin", "Access-Control-Allow-Headers", "Content-Type", "X-Requested-With"
    )
